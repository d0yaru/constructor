$(function(){
    ...
    $('.js-submit-constant').on('click', function(e){
        e.preventDefault();
...
function updateConstructor(){
     ...
     */
    if($('[name="size"]:eq(1):checked, [name="size"]:eq(2):checked').length > 0){
    ...
    /*
     * если выбрано освещение рабочей поверхности, то активируем инструментальную планку
     */
